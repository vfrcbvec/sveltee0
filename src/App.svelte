<script>
  ...
  import { faCaretDown, faFlag, faHome,faSpinner } from "@fortawesome/free-solid-svg-icons";
...
<main>
  <div class="holy-grail">
    <header>
        ...
        <div class="btn" on:click={() => onclik(0)}>Кошка</div>;
        <div class="btn" on:click={() => onclik(1)}>Яблоко</div>;
        <div class="btn" on:click={() => onclik(2)}>Лев</div>;
        <div class="btn" on:click={() => onclik(3)}>Зима</div>;
        <div class="btn" on:click={() => onclik(4)}>Пейзаж</div>;
